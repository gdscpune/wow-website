  ...
  return (
    <div id="agenda" className="pt-12">
      <div className="flex flex-col lg:flex-row justify-evenly items-center">
        <h1 className="text-black mt-4">Event Flow</h1>
      </div>
      ...
      {Sechedule.map((item) => (
        ...
        >
          <div className="col-span-2 my-3 items-center text-lg py-5 pr-5 lg:pr-0 text-center">
            {item.started}
          </div>
          <div className="col-span-10 px-5 py-6 align-middle border-secondary border-l-[5px] bg-white text-black rounded">
            <div className="flex items-center">
              <div className="mx-3">
                ...
                {/* {item.title.includes("Lunch" && "Activity") ? (
                  <div className="w-10 h-10 p-2 bg-blue-500 rounded text-center">
                    🍕
                  </div>
                ) : (
              ...
              <div>
                ...
                <p className="text-lg text-gray-500">{item.finished} </p>
              </div>
            </div>
          </div>
        </div>
