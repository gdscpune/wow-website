  ...
  return (
    <div className="mx-2 my-1 rounded-xl ">
      ...
      <div className="lg:flex my-10 mx-4 p-2 justify-center items-center">
        <div className="p-4 m-4 items-center h-100 w-100 bg-gradient-to-r from-red-600  to-orange-400 rounded-lg shadow-lg hover:-translate-y-2 transition duration-500">
        ...
        <div className="p-4 m-4 justify-center h-100 w-100 items-center bg-gradient-to-r from-red-600  to-orange-400 rounded-lg shadow-lg hover:-translate-y-2 transition duration-500">
          <li className="text-3xl text-slate-200 p-2 m-2 pb-5 list-none text-center">
            10+
            <br />
            Speakers
      ...
      <div className="flex flex-col w-full items-center lg:items-stretch lg:flex-row p-3 lg:p-5 py-2 bg-slate-200 rounded-xl lg:justify-space-between shadow-lg">
        ...
        {CardData.map((item) => {
          return (
            <div className="container flex justify-center p-0.5 my-4 mx-3 lg:transform lg:transition lg:duration-500 lg:hover:scale-110">
